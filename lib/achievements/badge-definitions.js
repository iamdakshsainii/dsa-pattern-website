export const BADGES = {
  ...
  'quiz-first-attempt': {
    ...
    icon: '📝',
    color: 'blue',
    condition: (stats) => stats.quizAttempts >= 1
  },
  'quiz-first-pass': {
    id: 'quiz-first-pass',
    name: 'Quiz Pass',
    ...
    icon: '✅',
    color: 'green',
    condition: (stats) => stats.quizPasses >= 1
  },
  'quiz-first-try-master': {
    id: 'quiz-first-try-master',
    name: 'First Try Master',
    description: 'Passed a quiz on first attempt with 80%+',
    icon: '🎯',
    color: 'gold',
    condition: (stats) => stats.firstTryPass80Plus === true
  },
  'quiz-persistent': {
    id: 'quiz-persistent',
    name: 'Persistent Learner',
    description: 'Used all 5 attempts on a roadmap',
    icon: '💪',
    color: 'orange',
    condition: (stats) => stats.quizAttempts >= 5
  },
  'quiz-master': {
    id: 'quiz-master',
    name: 'Roadmap Master',
    description: 'Passed 3+ quizzes out of 5 attempts',
    icon: '👑',
    color: 'purple',
    condition: (stats) => stats.quizPasses >= 3 && stats.quizAttempts >= 5
  },
  'quiz-comeback': {
    id: 'quiz-comeback',
    name: 'Comeback King',
    description: 'Failed 3 times then passed',
    icon: '🔥',
    color: 'indigo',
    condition: (stats) => stats.quizComebackStory === true
  },
  'quiz-perfect': {
    id: 'quiz-perfect',
    name: 'Perfect Score',
    ...
    icon: '💯',
    color: 'gold',
    condition: (stats) => stats.perfectQuizScore === true
  }
}
