...
export default function QuizCreator({ roadmap }) {
  ...
  function handleImportJSON() {
    try {
      ...
      if (Array.isArray(parsed)) {
        ...
        toast({
          title: "Success",
          description: `Imported ${imported.length} questions`
        })
        ...
        toast({
          title: "Success",
          description: "Imported 1 question"
        })
      } else {
        toast({
          title: "Error",
  ...
  const handleSave = async () => {
    ...
    if (questions.length === 0) {
      toast({
        title: "Error",
        description: "Add at least 1 question",
        variant: "destructive"
      })
      return
    }
              ...
              <TabsContent value="json" className="mt-4">
                <div className="space-y-4">
                  ...
                  <Textarea
                    ...
                    placeholder={`Single: {"question":"What is...","options":["A","B"],"correctAnswers":["A"]}

Array: [{"question":"Q1..."},{"question":"Q2..."}]`}
                    rows={10}
