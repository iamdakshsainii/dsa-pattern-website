...
export default function MentorshipRequestPage() {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `Mentorship Request - ${form.name}`,
        }),
      });
  ...
  const minChars = 50;
  const isValid = charCount >= minChars && form.name && form.email;
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            We'll reach out within 24 hours to schedule your mentoring session.
          </p>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Connect with mentors who've been in your shoes—they've struggled with these concepts and successfully mastered them.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          ...
          <Card className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200">
            ...
            <p className="text-sm text-muted-foreground">Book 1-on-1 call on <a href="https://topmate.io/your-profile" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">Topmate</a></p>
          </Card>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                💡 <strong>Be specific!</strong> Mention topics, concepts you're struggling with, or where you get stuck. The more detail (50+ words), the better we can help.
              </p>
            </div>
            ...
            <Card className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-800 dark:text-blue-200">
                  <strong>What to expect:</strong> Our mentors will analyze your progress, identify knowledge gaps, and provide personalized study plans with targeted resources.
                </div>
              </div>
            </Card>
            ...
            {!isValid && (charCount > 0 || form.name || form.email) && (
              <p className="text-xs text-orange-600 text-center">
                ...
                {charCount < minChars && `Write ${minChars - charCount} more characters to help us understand your challenges.`}
              </p>
            )}
          </form>
        </Card>
        ...
        <Card className="mt-6 p-4 bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 border border-yellow-300">
          <p className="text-sm text-center text-yellow-900 dark:text-yellow-200">
            ⚡ <strong>Fast response:</strong> We typically respond within 4-6 hours during business days
          </p>
        </Card>
      </div>
    </div>
