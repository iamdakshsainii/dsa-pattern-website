...
import { Edit2, Trash2, CheckCircle2, Image as ImageIcon, Code } from "lucide-react"
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-1 mb-3">
                {question.options.map((option, idx) => {
                  ...
                  return (
                    <div key={idx} className={`text-sm p-2 rounded ${isCorrect ? "bg-green-50 dark:bg-green-900/20 border border-green-200" : "bg-gray-50 dark:bg-gray-800"}`}>
              ...
              <div className="flex items-center gap-3 text-xs text-muted-foreground">
                ...
                {question.resources && question.resources.length > 0 && (
                  <span>{question.resources.length} resources</span>
                )}
              </div>
            </div>
