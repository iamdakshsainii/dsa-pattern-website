...
import QuizJsonImporter from "@/components/admin/quiz-json-importer"
...
export default function QuizCreator({ roadmap }) {
  ...
  const handleJsonImport = (importedQuizName, importedQuestions) => {
    if (!quizName) {
      setQuizName(importedQuizName)
    }
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <QuizJsonImporter onImport={handleJsonImport} />
